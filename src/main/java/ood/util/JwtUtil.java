...
public class JwtUtil {
    ...
    public static String generateToken(User user) {
        ...
        Claims claims = Jwts.claims();//use api create a new empty claim
...
//        }
//
//        claims.put("allowedReadResources", allowedReadResources.replaceAll(".$", ""));// replace any last character to "" (regular expression)
